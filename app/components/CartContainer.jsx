                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td className="text-center">
                            <h5><strong>
                                  ${props.order.glasses && props.order.glasses.reduce((totalPrice, glasses) => {
                      ...
                      <tr>
                          ...
                          <td className="text-center"><h3><strong>${  props.order.glasses && props.order.glasses.reduce((totalPrice, glasses) => {
                                                                      return totalPrice + glasses.price / 100 
                                                                   }, 10.94)} </strong></h3></td>
                      </tr>
                       <tr>
